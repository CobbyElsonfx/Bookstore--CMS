...
**Bookstore CMS** The Bookstore is a website similar to the "Awesome Books" website built in with vanilla JS, it allows you to  display a list of books, add a book and remove a selected book
...
```sh
  cd project-folder
  git clone https://github.com/CobbyElsonfx/bookstore.git
```
